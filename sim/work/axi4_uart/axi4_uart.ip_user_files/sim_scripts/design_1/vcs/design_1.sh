...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hieu/Workspace/APB_UART/sim/work/axi4_uart/axi4_uart.cache/compile_simlib/vcs"
  fi
